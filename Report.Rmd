---
title: "Predicting UFC Fight Winners"
output:
  pdf_document:
date: "2023-12-11"
...
Another limitation within our data is that for a fighter's first career UFC fight, they have no historical data and thus their respective columns are N/A in our dataset. Since our modeling techniques require clean data without missing entries, we will need to remove instances of a fighter's first fight.
...
```{r model 1 diagnostics, fig.height = 4, fight.width = 4}
...
```{r model 2 diagnostics, fig.height=4, fig.width = 4}
...
```{r model 3 diagnostics, fig.height = 4, fight.width = 4}
...
```{r model 4 diagnostics, fig.height = 4, fight.width = 4}
