...
# Move this to results
#kable(Class2_stats, digits = 3, caption = "Class 2 Elastic Net Model Accuracy") %>% kable_styling(latex_options = "hold_position")
```
...
$$B_0 + B_1 * B\_avg\_opp\_KD + B_2 * B\_avg\_opp\_SIG\_STR\_pct + B_3 * B\_avg\_opp\_SIG\_STR\_pct^2 + $$
...
### Class 4 Model VIF Values

```{r}
kable(vif(final_model4_interactions), caption = "VIF Values for Class 4 Elastic Net Model", digits = 2) %>% kable_styling(latex_options = "hold_position")
```



### Class 4 Other Model Accuracy Measures 
...
kable(Class4_sim_stats, digits = 3, caption = "Class 4 Elastic Net --> Sig. P-Value Model Accuracy") %>% kable_styling(latex_options = "hold_position")
```
...
kable(Class4_bss_stats, digits = 3, caption = "Class 4 Elastic Net --> Best Subset Selection") %>% kable_styling(latex_options = "hold_position")
```
...
# Plot the ROC curve
plot(roc_4, main = "ROC Curve for the Class 3
     Logistic Regression Model")
abline(0, 1, lty = 2, col = "gray")  # Add a reference line for a random classifier
