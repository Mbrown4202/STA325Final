...
The elastic net models ran above indicate the most important predictors in determining a fight's winner within our weight class segmentation. Below we will explore including nonlinear and interaction effects to attempt to improve predictive accuracy with interpretability as less of a priority. 
