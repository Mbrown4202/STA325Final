...
p1 <- ggplot(data = data, aes(x = fight_gender)) + geom_bar() + labs(title = "# of Fights by Gender")
p2 <- ggplot(data = data, aes(x = Winner)) + geom_bar() + labs(title = "Frequency of Winner", subtitle = "By Corner Classification")
